...
A project-memory benchmark that checks whether AgentGit finds the commit context a new teammate or future agent would need.

## Executive Summary

AgentGit found the right commit in the top 3 for 91% of questions. Exact grep found 0%. The stronger keyword sanity check found 64%.

Compared with the stronger keyword baseline, AgentGit improves top-3 accuracy by +27 points and mean reciprocal rank by +0.34.

AgentGit beat exact grep on 11/11 questions and beat the stronger keyword baseline on 6/11 questions.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| AgentGit vs exact grep | +73 points | +91 points | +100 points | +0.82 | 11/11 | 0/11 |
| AgentGit vs keyword sanity check | +45 points | +27 points | +27 points | +0.34 | 6/11 | 4/11 |
...
| --- | --- | --- | ---: | ---: | ---: | --- | --- |
| What is this project and how does AgentGit remember code decisions? | A beginner asks for the original product plan and purpose. | 379a3d1, a69f576, 556e9cb | 1 | miss | miss | a69f576 Clarify the purpose and usage of AgentGit in the README. | 1dd7f00 Add benchmark for AgentGit search value |
...
| What are the rules for agents before and after making code changes? | A new agent needs the repository workflow instructions. | c4250c8 | 3 | miss | miss | a69f576 Clarify the purpose and usage of AgentGit in the README. | no result |
...
| How do we backfill AgentGit memory from old git history? | A maintainer wants to create memories for commits that happened before AgentGit was installed. | 0d315da | 1 | miss | 2 | 0d315da To enable the backfilling of agent commits from existing git history into the database. | 1dd7f00 Add benchmark for AgentGit search value |
| How does AgentGit separate memories for different repositories? | A team wants to avoid mixing memories from different projects. | 62975e3 | 5 | miss | 2 | 379a3d1 Establish a foundational command-line interface for managing agent commits alongside Git commits. | 1dd7f00 Add benchmark for AgentGit search value |
